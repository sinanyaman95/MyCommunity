...
public class FoodContent {
    ...
    private static ArrayList<Food> fillFoodList() {
        ...
        tempFoodList.add(new Food("Rogan Josh",R.drawable.rogan_josh,"https://goo.gl/maps/45Vh9QDFjPNmP1Xd9","indian"));
        ...
        tempFoodList.add(new Food("Lentil Soup", R.drawable.mercimek,"https://g.page/Lezizkitchen?share","turkish"));
        tempFoodList.add(new Food("Kebab", R.drawable.kebap,"https://goo.gl/maps/NeYhecJ5YRGuNn7S6","turkish"));
        tempFoodList.add(new Food("Manti", R.drawable.manti,"https://goo.gl/maps/Pnd6kvCGk17nDFbu7","turkish"));
        tempFoodList.add(new Food("Garam Masala", R.drawable.garam_masala,"https://goo.gl/maps/4dNxbk7FDPSLtdmn9","indian"));
        tempFoodList.add(new Food("Al-Aruba", R.drawable.cheese,"https://www.google.com/maps/place/Al-Aruba+Restaurant/@43.7307089,-79.5482199,15z/data=!4m8!1m2!2m1!1srestaurant!3m4!1s0x0:0xaa4eec105e102482!8m2!3d43.7254675!4d-79.5514253","indian"));
        ...
        tempFoodList.add(new Food("Pongal",R.drawable.pongal,"https://goo.gl/maps/11BXEimDUa4rFWnW7","indian"));
